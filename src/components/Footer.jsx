          ...
          <div className="grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4">
            ...
            <div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
              ...
              <form className="mt-4 flex flex-col md:flex-row">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wider text-white transition duration-200 rounded shadow-md hover:bg-orange-500 focus:outline-none border"
                >
                  Subscribe
                </button>
              </form>
              <p className="mt-4 text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore quos ratione eum corrupti praesentium quidem quisquam? Nostrum pariatur quia minus tempora rem eius iste quos? Reprehenderit, suscipit quibusdam. Exercitationem, quae!
              Modi eum amet pariatur cum nemo corporis non voluptas mollitia nulla, praesentium et consectetur voluptatum nisi iure! Laborum vel dolores aliquid aut autem. Nisi doloribus eos, voluptates magni veniam quam?
               </p>
               </div>
          </div>
        </div>
        <div  className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
            <p className="text-sm text-gray-500 inline-flex">© Copyright 2024 | All rights reserved.</p>
