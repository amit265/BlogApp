  ...
  return (
    ...
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4">
      <div className="grid mb-8 lg:grid-cols-6 gap-5">
        ...
        <div className="md:col-span-2 lg:col-span-2 lg:mt-0 mt-5">
          ...
          <form className="mt-4 flex flex-col md:flex-row">
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wider text-white transition duration-200 bg-orange-500 rounded shadow-md hover:bg-orange-600 focus:outline-none"
            >
              Subscribe
            </button>
          </form>
          <p className="mt-4 text-sm text-gray-500">
            ...
            quos ratione eum corrupti praesentium quidem quisquam? Nostrum
            pariatur quia minus tempora rem eius iste quos? Reprehenderit,
            suscipit quibusdam. Exercitationem, quae! Modi eum amet pariatur cum
            nemo corporis non voluptas mollitia nulla, praesentium et
            consectetur voluptatum nisi iure! Laborum vel dolores aliquid aut
            autem. Nisi doloribus eos, voluptates magni veniam quam?
          </p>
        </div>
      </div>
